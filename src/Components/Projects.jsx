          ...
          <div key={index} id="imgid" className="shadow-4xl p-2   rounded-xl" >
            <a href={item.link} target='_blank' >
              <div id="projimg" className="relative group h-60 flex justify-center items-center m-3 overflow-hidden rounded-lg">
                ...
                <button
                  id="projbutton"
                  className="absolute left-1/2 -translate-x-1/2 top-0 bg-[#d3f733] text-gray-700 px-6 py-0.5 text-lg rounded-bl-lg rounded-br-lg shadow-md opacity-0 group-hover:opacity-100 transform -translate-y-full group-hover:translate-y-0 transition-all duration-500 ease-in-out z-10">
                  Visit
                </button>
              </div>
