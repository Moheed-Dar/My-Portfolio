        ...
        <div className='grid grid-flow-row grid-rows-3'>
          ...
          <div className="md:mb-5 mb-3 mt-2 md:mt-3 mx-10">
            <div className="flex justify-between items-center mb-3">
              <h2 data-aos="zoom-in-right" className="text-blue-200  cursor-none font-semibold text-sm md:text-2xl">Front-End Development</h2>
          ...
          <div className="md:mb-5 mb-3 mt-2 md:mt-3 mx-10">
            <div className="flex justify-between items-center mb-3">
              <h2 data-aos="zoom-in-right" className="text-blue-200 cursor-none font-semibold text-sm md:text-2xl">Back-End Development</h2>
          ...
          <div className="md:mb-5 mb-3 mt-2 md:mt-3 mx-10">
            <div className="flex justify-between items-center mb-3">
              <h2 data-aos="zoom-in-right" className="text-blue-200 cursor-none font-semibold text-sm md:text-2xl">Editing & Other Skills</h2>
              <span className="text-white font-medium text-sm md:text-md">70%</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-1.5 md:h-2.5 dark:bg-gray-700">
              <motion.div  data-aos="fade-right" className="bg-[#5AE4A8] h-1.5 md:h-2.5 rounded-full"
              initial={{ width: '0%' }}
              animate={{ width: '70%' }}
