        ...
        <div  className="grid grid-cols-3 md:grid-cols-4  md:pt-7 pt-4 md:mb-10 lg:grid-cols-6 gap-4 md:gap-5 px-3">
          {SkillsData.map((item) => (
            <div
              ...
              className="p-2 mb-2 cursor-pointer shadow-slate-300   md:hover:shadow-2xl hover:shadow-xl  overflow-hidden rounded-lg flex items-center justify-center group transition-transform duration-300"
            >
